...
public class DatePickerDialog extends DialogFragment implements
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth, int dayOfWeek);
    }
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
        ...
        ret.initialize(callBack, year, monthOfYear, dayOfMonth,dayOfWeek);
        return ret;
    }

    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, int dayOfWeek) {
        mCallBack = callBack;
    ...
    public void notifyOnDateListener() {
        if (mCallBack != null) {
            mCallBack.onDateSet(DatePickerDialog.this, mCalendar.get(Calendar.YEAR),
                    mCalendar.get(Calendar.MONTH), mCalendar.get(Calendar.DAY_OF_MONTH), mCalendar.get(Calendar.DAY_OF_WEEK));
        }
    }
}
